...
import jp.kineita.fragmentnavigation.adapter.base.PagerAdapter
import jp.kineita.fragmentnavigation.extensions.invisible
import jp.kineita.fragmentnavigation.extensions.tryCatch
import jp.kineita.fragmentnavigation.extensions.visible
import jp.kineita.fragmentnavigation.transformer.NavigatorPageTransformer
...
open class FragmentNavigator : ViewGroup {
    ...
    var adapter: PagerAdapter?
        ...
        set(adapter) {
            ...
            // Dispatch the change to any listenersrr
