...
import jp.kineita.fragmentnavigation.adapter.NavigatorAdapter
import jp.kineita.fragmentnavigation.common.Arg
import jp.kineita.fragmentnavigation.common.BundleBuilder
...
class Navigator : FragmentNavigator {
    ...
    @Deprecated(
            ...
            replaceWith = ReplaceWith(
                    ...
                    imports = ["jp.kineita.fragmentnavigation.Navigator"]
            )
    )
    fun addFragment(
            fragment: Fragment,
