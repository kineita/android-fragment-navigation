...
package jp.kineita.fragmentnavigation.adapter.base
...
import jp.kineita.fragmentnavigation.extensions.log
import jp.kineita.fragmentnavigation.extensions.simpleName
...
//                mCurTransaction!!.attach(f).commitNowAllowingStateLoss()
        ...
        if (position > 0) {
            mCurTransaction!!.setMaxLifecycle(getItem(position - 1), Lifecycle.State.STARTED)
        }
...
//            null)
    ...
    companion object {
         ...
         */
        @Deprecated(
                "This behavior relies on the deprecated\n" +
